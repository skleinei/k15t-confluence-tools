...
# In ~confluence, a symlink called atlassian-confluence is created to the extracted standalone version. This symlink can be updated when later versions are installed.
...
CONFLUENCE_STD="atlassian-confluence"
CONFLUENCE_HOME="confluence-home"
CONFLUENCE_DOWNLOAD="http://www.atlassian.com/software/confluence/downloads/binary/atlassian-confluence-$CONFLUENCE_VERSION.tar.gz"
CONFLUENCE_FOLDER="atlassian-confluence-$CONFLUENCE_VERSION"
CONFLUENCE_DOWNLOAD_TMP="$TMP_DIR/atlassian-confluence-$CONFLUENCE_VERSION.tar.gz"
